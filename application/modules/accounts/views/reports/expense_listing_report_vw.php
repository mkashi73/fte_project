...
tr:nth-child(even) {
  background-color: #dddddd;
    ...
    <body>
		...
		<h4 style="text-align: center;">Expense Detail Report</h4>
		<?php 
		$record = $result[0];
		?>
		...
		<table border="1" style="margin-top: 10px;">
			<tr>
				...
				<td style="padding: 2px; width: 150px;">
					<span style="font-size: 9px;"><strong>Expense ID</strong></span>
				</td>
				<td style="padding: 2px; width: 550px;">
					<span style="font-size: 9px;"><strong>Branch Name</strong></span>
				</td>
				<td style="padding: 2px; width: 200px;">
					<span style="font-size: 9px;"><strong>Expense Amount</strong></span>
				</td>
		...
		?>
			...
			<tr>
				...
				<td style="padding: 2px; width: 150px;">
					<span style="font-size: 10px;"><?= $record['EXPENSE_ID'] ?></span>
				</td>
				<td style="padding: 2px; width: 300px;">
				    <span style="font-size: 10px;"><strong><?= $record['STATION_NAME'] ?></strong></span><br />					
				</td>
				<td style="padding: 2px; width: 300px;">
					<span style="font-size: 10px;"><?= $record['EXPENSE_AMOUNT'] ?></span>
				</td>
				<td style="padding: 2px; width: 300px;">
