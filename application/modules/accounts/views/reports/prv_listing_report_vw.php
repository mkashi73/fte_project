...
tr:nth-child(even) {
  background-color: #dddddd;
    ...
    <body>
		...
		<h4 style="text-align: center;">PRV Detail Report</h4>
		<?php 
		$record = $result[0];
		?>
		...
		<table border="1" style="margin-top: 10px;">
			<tr>
				...
				<td style="padding: 2px; width: 150px;">
					<span style="font-size: 9px;"><strong>PRV Number</strong></span>
				</td>
		...
		?>
			...
			<tr>
				...
				<td style="padding: 2px; width: 150px;">
					<span style="font-size: 10px;"><?= $record['PRV_ID'] ?></span>
				</td>
				<td style="padding: 2px; width: 300px;">
				    <span style="font-size: 10px;"><strong><?= $record['STATION_NAME'] ?></strong></span><br />					
				</td>
				<td style="padding: 2px; width: 300px;">
					<span style="font-size: 10px;"><?= $record['RECEIVED_FROM'] ?></span>
				</td>
				<td style="padding: 2px; width: 300px;">
