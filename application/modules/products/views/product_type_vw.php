					 ...
					 <div class="row">
                        ...
                        <div class="col-md-4">
						  <div class="form-group">
							...
							<input class="form-control" type="text" name="shippername" placeholder="Ex: Mu***** kas****">
						  </div>
						</div><!-- col-4 -->
						<!-- Shipper Phone -->
						<div class="col-md-4">
						  <div class="form-group">
							...
							<input class="form-control" type="text" name="shipperphone" placeholder="Ex: 0300-*******">
						  </div>
						</div><!-- col-4 -->
						...
						<div class="col-md-4">
						  <div class="form-group bd-t-0-force">
							...
							<input class="form-control" type="text" name="shipperEmailAddress" placeholder="mkas***@****.com">
						  </div>
						</div><!-- col-8 -->
						...
						<div class="col-md-4">
						  <div class="form-group mg-md-l--1 bd-t-0-force parsley-input" id="scWrapper">
						      	...
						      	<select class="form-control countrySearch recieverCountrySearch" name="shipperCountryId" data-parsley-class-hanlder="#scWrapper" required>
						...
						<div class="col-md-4">
						  <div class="form-group mg-md-l--1 bd-t-0-force parsley-input" id="statewrapper">
								...
								<select class="form-control stateSearch recieverStateSearch" name="shipperStateId" data-parsley-class-hanlder="#statewrapper" required>
								</select>
						  </div>				  
						</div><!-- col-4 -->
						...
						<div class="col-md-4">
						  <div class="form-group mg-md-l--1 bd-t-0-force parsley-input" id="cityWrapper">
						      <label style="color: #000000de;">Shipper City (Required)</label>
								<select class="form-control citySearch receiverCitySearch" name="shipperCityId" data-parsley-class-hanlder="#cityWrapper" required>
								</select>
						  </div>				  
						</div><!-- col-4 -->
						...
						<div class="col-md-4">
						  <div class="form-group">
							...
							<input class="form-control" type="text" name="shipperzipcode" placeholder="Ex: 25000">
						  </div>
						</div><!-- col-4 --> 
						<!-- Used for CNIC -->
						<div class="col-md-4">
						  <div class="form-group">
							...
							<input class="form-control" type="text" name="productActualPrice" placeholder="*****-*******-*">
						  </div>
						</div><!-- col-4 -->
						<!-- Shipper Address -->
						<div class="col-md-8">
						  <div class="form-group bd-t-0-force">
							...
							<textarea class="form-control" type="text" name="shipperaddress" placeholder="Ex: House No **, Muhallah ******, Street No ****"></textarea>
						  </div>
						</div><!-- col-8 -->
						...
						<div class="col-md-4">
						  <div class="form-group">
							...
							<input class="form-control" type="text" name="receivedamount" placeholder="Ex: 32000">
						  </div>
						</div><!-- col-4 -->
						<!-- Balance Amount -->
						<div class="col-md-4">
					  ...
					  <div class="form-layout-footer bd pd-20 bd-t-0 mt-3">
						<button type="submit" class="btn btn-success bd-0 submitBtn">Save Product</button>
				  ...
				  <div class="form-layout">
					 <div class="row">
						...
						<div class="col-md-4">
						  <div class="form-group">
							...
							<input class="form-control" type="text" id="updateShipperName" name="shippername" >
						  </div>
						</div><!-- col-4 -->
						...
						<div class="col-md-4">
						  <div class="form-group">
						      <label style="color: #000000de;">Shipper Phone</label>
							<input class="form-control" type="text" id="updateShipperPhone" name="shipperphone" >
						  </div>
						</div><!-- col-4 -->
						<!-- Shipper Email Address -->
						<div class="col-md-4">
						  <div class="form-group bd-t-0-force">
						      <label style="color: #000000de;">Shipper Email Address</label>
							<input class="form-control" type="text" id="updateShipperEmailAddress" name="shipperEmailAddress">
						  </div>
						</div><!-- col-4 -->
						...
						<div class="col-md-4">
						  <div class="form-group mg-md-l--1 bd-t-0-force">
						      <label style="color: #000000de;">Shipper Country</label>
								<select class="form-control" id="updateShipperCountry" name="shipperCountryId">
								  	<option label="Select Country"></option>
								  	<?php foreach( $getCountry as $country) : ?>
									<option value="<?= $country['COUNTRY_ID'] ?>"> <?= $country['COUNTRY']; ?></option>							  		
								  	<?php endforeach; ?>
						...
						<div class="col-md-4">
						  <div class="form-group mg-md-l--1 bd-t-0-force">
								...
								<select class="form-control " id="updateShipperState" name="shipperStateId">
								</select>
						  </div>				  
						</div><!-- col-4 -->
						...
						<div class="col-md-4">
						  <div class="form-group mg-md-l--1 bd-t-0-force">
								...
								<select class="form-control " id="updateShipperCity" name="shipperCityId">
								</select>
						  </div>				  
						</div><!-- col-4 -->
						...
						<div class="col-md-4">
						  <div class="form-group">
						      <label style="color: #000000de;">Shipper ZipCode</label>
							<input class="form-control" type="text" id="updateShipperZipcode" name="shipperzipcode" >
						  </div>
						</div><!-- col-4 -->
						<!-- Used for CNIC -->
						<div class="col-md-4">
						  <div class="form-group">
							...
							<input class="form-control" type="text" name="productActualPrice" id="updateProductActualPrice" placeholder="">
						  </div>
						</div><!-- col-4 -->
						...
						<div class="col-md-8">
						  <div class="form-group bd-t-0-force">
						      <label style="color: #000000de;">Shipper Address</label>
							<textarea class="form-control" type="text" id="updateShipperAddress" name="shipperaddress"></textarea>
						  </div>
						</div><!-- col-8 -->
						...
						<div class="col-md-4">
						  <div class="form-group">
						      <label style="color: #000000de;">Consignee's Name</label>
							<input class="form-control" type="text" id="updateConsigneeName" name="consigneername" >
						  </div>
						</div><!-- col-4 -->
						...
						<div class="col-md-4">
						  <div class="form-group">
						      <label style="color: #000000de;">Consignee's Phone</label>
							<input class="form-control" type="text" id="updateConsigneePhone" name="consigneephone">
						  </div>
						</div><!-- col-4 -->
						<!-- Consignee Email Address -->
						<div class="col-md-4">
						  <div class="form-group bd-t-0-force">
						      <label style="color: #000000de;">Consignee Email Address</label>
							<input class="form-control" type="text" id="updateConsigneeEmailAddress" name="consigneeEmailAddress">
						  </div>
						</div><!-- col-4 -->
						...
						<div class="col-md-4">
						  <div class="form-group mg-md-l--1 bd-t-0-force">
						      <label style="color: #000000de;">Consignee Country</label>
								<select class="form-control" id="updateConsigneeCountry" name="consigneeCountryId">
								  	<option label="Select Country"></option>
								  	<?php foreach( $getCountry as $country) : ?>
									<option value="<?= $country['COUNTRY_ID'] ?>"> <?= $country['COUNTRY']; ?></option>							  		
								  	<?php endforeach; ?>
						...
						<div class="col-md-4">
						  <div class="form-group mg-md-l--1 bd-t-0-force">
						      <label style="color: #000000de;">Consignee State</label>
								<select class="form-control" id="updateConsigneeState" name="consigneeStateId">
						...
						<div class="col-md-4">
						  <div class="form-group mg-md-l--1 bd-t-0-force">
						      <label style="color: #000000de;">Consignee City</label>
								<select class="form-control" id="updateConsigneeCity" name="consigneeCityId">
						...
						<div class="col-md-4">
						  <div class="form-group">
						      <label style="color: #000000de;">Consignee's ZipCode</label>
							<input class="form-control" type="text" id="updateConsigneeZipcode" name="consigneezipcode">
						  </div>
						</div><!-- col-4 -->
						...
						<div class="col-md-8">
						  	<div class="form-group bd-t-0-force">
						  	    <label style="color: #000000de;">Consignee's Address</label>
								<textarea class="form-control" type="text" id="updateConsigneeAddress" name="consigneeaddress"></textarea>
						  	</div>
						</div><!-- col-8 -->
						<!-- /////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////// -->
						...
						<div class="col-md-4">
						  <div class="form-group">
						      <label style="color: #000000de;">Product Name</label>
							<input class="form-control" type="text" id="updateProductName" name="productname" >
						  </div>
						</div><!-- col-4 -->
						<!-- Club Number -->
						<div class="col-md-4">
						  <div class="form-group bd-t-0-force">
						      <label style="color: #000000de;">Club Number</label>
							<input class="form-control" type="text" id="updateClubNumber" name="clubNumber" >
						  </div>
						 </div><!-- col-4 -->
					...
					<div class="col-md-4">
					  <div class="form-group mg-md-l--1 bd-t-0-force">
						...
						<select id="updateProductType" name="productType" class="form-control" >
					...
					<div class="col-md-4">
					  <div class="form-group">
					      <label style="color: #000000de;">External Tracking No</label>
						<input class="form-control" type="text" id="updateExtTrackingno" name="exttrackingno">
					  </div>
					</div><!-- col-4 -->
					<div class="col-md-4">
					  <div class="form-group mg-md-l--1 bd-t-0-force">
					...
					<div class="col-md-4">
					  <div class="form-group mg-md-l--1 bd-t-0-force">
						...
						<select id="updateProductCondition" name="productCondition" class="form-control" >
					...
					<div class="col-md-4">
					  <div class="form-group mg-md-l--1 bd-t-0-force">
						...
						<select id="updateProductStatus" name="productStatus" class="form-control">
					...
					<div class="col-md-4">
					  <div class="form-group">
					      <label style="color: #000000de;">Received Amount</label>
						<input class="form-control" type="text" id="updateRecieveAmount" name="receivedamount">
					  </div>
					</div><!-- col-4 -->
					<div class="col-md-4">
					  <div class="form-group">
					      <label style="color: #000000de;">Balance Amount</label>
						<input class="form-control" type="text" id="updateBalanceAmount" name="balanceamount">
					  </div>
					</div><!-- col-4 -->
					<!-- ////////////////////////     NEW FIELDS ADDED     ////////////////////////////////////////////// -->
						<!-- MAB Number -->
					...
					<div class="col-md-4">
					  <div class="form-group">
						<input type="hidden" class="updateProductId" name="productId" >
					  </div>
					</div><!-- col-4 -->
				  </div><!-- row -->	
