						...
						<div class="col-md-4"> <!-- dropdown-->
						  <div class="form-group">
						      <label style="color: #000000de;">Client List</label>
						        <select name="CLIENT_ID" class="form-control select2" id="#selet-client" data-placeholder="Select User">
	                 			 	<option label="Select Client"></option>
							      
							        	<?php foreach( $client AS $clientRecord) :?>
	                    			<option value="<?= $clientRecord['CLIENT_ID'] ?>"><?= $clientRecord['CLIENT_NAME'] ?></option>
                  					<?php endforeach; ?>  
						        </select>
					 ...
					 <div class="row">
						...
						<div class="col-md-4">
						  <div class="form-group">
							...
							<input class="form-control" type="text" name="productActualPrice" id="updateShipperNic" placeholder="" <?= $disabledopt ?> >
						  </div>
						</div><!-- col-4 -->
						...
						<div class="col-md-4"> <!-- dropdown-->
						  <div class="form-group">
						      <label style="color: #000000de;">Client List</label>
						        <select name="CLIENT_ID" class="form-control " data-placeholder="Select User" name="client" id="updateClient" <?= $disabledopt ?>>
	                 			 	<option label="Select Client"></option>
