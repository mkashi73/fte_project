...
<div style='padding-left: 70px; padding-right: 70px; width: 600px;'>
	...
	<span style="text-align: left; font-size: 24px;">Commercial Performa Invoice</span><br />	<br />		
	
	<table  border="1">
		
		<tr>
		<td style="width: 300px; padding: 15px;">
		        <span style="text-align: left; font-size: 24px;">EIC Trading</span>
				<br />
				
				
				
				<label id="lblShipperAddress">
					21B Buckingham Avenue<br>
                    Slough SL1 4QA,<br>
                    United Kingdom
				</label>
				<br />
			...
			<td style="width: 300px; padding: 15px;">
				...
				<span style="font-weight: bold; font-size: 18px;">NIC: </span><label id="lblCNIC"></label><br /><hr />
	...
	<table border="1">
	    <tr>
	        <td style="width: 300px;">
	            <span style="font-weight: bold; font-size: 18px;  padding: 15px;">VAT #: </span>
	            <label id="lblVAT">
	            	<?= $productRecord[0]['VAT_NUMBER']; ?>
            	</label>
	        </td>
	        <td style="width: 300px;">
	            <span style="font-weight: bold; font-size: 18px;  padding: 15px;">EORI #: </span>
	            <label id="lblEORI">
	            		<?= $productRecord[0]['EORI_NUMBER']; ?>
            	</label>
	        </td>
	        <td style="width: 300px;">
	            <span style="font-weight: bold; font-size: 18px;  padding: 15px;">Form E #: </span>
            	<label id="lblFormE">
            		<?= $productRecord[0]['FORM_E_NUMBER']; ?>
        		</label>
	        </td>
	    </tr>
	</table><br />
