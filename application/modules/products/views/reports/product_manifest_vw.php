...
<html xmlns="http://www.w3.org/1999/xhtml" xmlns:v="urn:schemas-microsoft-com:vml" xmlns:o="urn:schemas-microsoft-com:office:office">
    <head>
        ...
        <title>Product Manifest | FTE</title>
...
tr:nth-child(even) {
  background-color: #dddddd;
    ...
    <body>
        ...
        <!--<![endif]-->
        <!--*|END:IF|*-->
        <div style='padding-left: 70px; padding-right: 70px; width: 900px;'><br />
		<h3 style="text-align: center;">FAST TRACK EXPRESS</h3>
		<h4 style="text-align: center;">Manifist Report</h4>
		<?php 
		$record = $result[0];
		?>
		<table border="1" style="margin-top: 20px">
			<tr>
				<td style="padding: 5px; width: 150px;">
					<span style="font-size: 12px;">Dated: 
						<label id="lblCurrentDate">
							<strong><?= $record['E_DATE_TIME'] ?></strong>
						</label>
					<span>
				</td>
				<td style="padding: 5px; width: 150px;">
					<span style="font-size: 12px;">No of Parcels: 
						<label id="lblnoofParcels"> 
						<strong><?= $total_parcels ?></strong>
						</label>
					<span>
				</td>
				<td style="padding: 5px; width: 300px;">
					<span style="font-size: 12px;">MAWB #: 
						<label id="lblMAWB"> 
							<strong><?= $record['MAB_NUMBER'] ?></strong>
						</label>
					<span>
				</td>
				<td style="padding: 5px; width: 150px;">
					<span style="font-size: 12px;">
						Total Bags: 
						<label id="lblTotalBags"> 
						   <strong><?= $total_bags ?></strong>
						</label>
					<span>
				</td>
			</tr>
		...
		<table border="1" style="margin-top: 10px;">
			<tr>
				<td style="padding: 2px; width: 70px;">
					<span style="font-size: 9px;"><strong>S.No</strong></span>
				</td>
				<td style="padding: 2px; width: 150px;">
					<span style="font-size: 9px;"><strong>AWB#</strong></span>
				</td>
				<td style="padding: 2px; width: 550px;">
					<span style="font-size: 9px;"><strong>Shipper Detail</strong></span>
				</td>
				<td style="padding: 2px; width: 100px;">
					<span style="font-size: 9px;"><strong>PCS</strong></span>
				</td>
				<td style="padding: 2px; width: 200px;">
					<span style="font-size: 9px;"><strong>Weight</strong></span>
				</td>
				<td style="padding: 2px; width: 300px;">
					<span style="font-size: 9px;"><strong>Dimension</strong></span>
				</td>
				<td style="padding: 2px; width: 200px;">
					<span style="font-size: 9px;"><strong>Bag No</strong></span>
				</td>
				<td style="padding: 2px; width: 550px;">
					<span style="font-size: 9px;"><strong>Consignee Detail</strong></span>
				</td>
				<td style="padding: 2px; width: 300px;">
					<span style="font-size: 9px;"><strong>External Tracking</strong></span>
				</td>
			</tr>
		...
		?>
			...
			<tr>
				...
				<td style="padding: 2px; width: 150px;">
					<span style="font-size: 10px;"><?= $record['CN_NUMBER'] ?></span>
				</td>
				<td style="padding: 2px; width: 300px;">
				    <span style="font-size: 10px;"><strong><?= $record['SHIPPER_NAME'] ?></strong></span><br />
					<span style="font-size: 10px;"><?= $record['SHIPPER_ADDRESS'] ?></span><br />
					<span style="font-size: 10px;"><?= $record['SHIPPER_PHONE'] ?></span>
				</td>
				<td style="padding: 2px; width: 300px;">
					<span style="font-size: 10px;"><?= $record['QUANTITY'] ?></span>
				</td>
				<td style="padding: 2px; width: 300px;">
					<span style="font-size: 10px;"><?= $record['PRODUCT_NET_WEIGHT'] ?></span>
				</td>
				<td style="padding: 2px; width: 300px;">
					<span style="font-size: 10px;"><?= $record['PRODUCT_DIMENSION'] ?></span>
				</td>
				<td style="padding: 2px; width: 300px;">
					<span style="font-size: 10px;"><?= $record['BAG_NUMBER'] ?></span>
				</td>
				<td style="padding: 2px; width: 300px;">
				    <span style="font-size: 10px;"><strong><?= $record['CONSIGNEE_NAME'] ?></strong></span> <br />
					<span style="font-size: 10px;"><?= $record['CONSIGNEE_ADDRESS'] ?></span>
				</td>
				<td style="padding: 2px; width: 300px;">
					<span style="font-size: 10px;"><?= $record['EXT_TRACKING_NUMBER'] ?></span>
				</td>
			</tr>
		<?php 
			$i++;
